...
function Header({ settings = false, small = false }) {
  ...
  return (
    <div className={`bg-violet-900 drop-shadow-md flex items-center px-5 ${small ? 'w-3/4 max-w-lg mx-auto rounded-b-lg' : 'w-screen'} ${settings ? 'justify-between' : 'justify-center'}`}>
